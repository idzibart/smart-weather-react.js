...
export default function DisplayWeather({
  ...
  return (
    <div className="grid w-full justify-stretch gap-8 p-4">
      {weatherData && isLoading ? (
        <>
          ...
          <div className="m-auto flex justify-center gap-6 rounded-xl bg-slate-200 bg-opacity-70 px-3 py-3 text-center shadow-lg">
            <div>
              <FaTemperatureArrowUp className="m-auto text-2xl text-red-600" />
              <div>
            ...
            <div>
              <FaTemperatureArrowDown className="m-auto text-2xl text-blue-600" />
              <div>
